    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView style={styles.scrollContainer} contentContainerStyle={styles.content}>
        <View style={[styles.section, { borderColor: colors.border }]}>
          ...
          <Text style={styles.bold}>Lähteet:</Text>
          <Text style={[styles.paragraph, { color: colors.text }]}>
            Edmonds, L. A. (2016). <a href="https://doi.org/10.1097/TLD.0000000000000088">A Review of Verb Network Strengthening Treatment: Theory, Methods, Results, and Clinical Implications. Topics in Language Disorders, 36(2), 123–135.</a>

          </Text>

          <Text style={[styles.paragraph, { color: colors.text }]}>

            Edmonds, L. A., Mammino, K., & Ojeda, J. (2014). <a href="https://doi.org/10.1044/2014_AJSLP-13-0098">Effect of Verb Network Strengthening Treatment (VNeST) in Persons With Aphasia: Extension and Replication of Previous Findings. American Journal of Speech-Language Pathology, 23(2), S312.</a>
          ...
          <Text style={[styles.paragraph, { color: colors.text }]}>
            ...
            Edmonds, L. A., Nadeau, S. E., & Kiran, S. (2009). <a href="https://doi.org/10.1080/02687030802291339">Effect of Verb Network Strengthening Treatment (VNeST) on lexical retrieval of content words in sentences in persons with aphasia. Aphasiology, 23(3), 402–424.</a>
