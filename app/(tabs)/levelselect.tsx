...
export default function LevelSelectScreen() {
  ...
  // JSON has groupId: 0 (set "1"), groupId: 1 (set "2"), groupId: 2 (set "3")
  const sets: Set[] = [
    { id: 0, name: "Taso 1", displayNumber: 1 },
    { id: 1, name: "Taso 2", displayNumber: 2 },
    { id: 2, name: "Taso 3", displayNumber: 3 },
  ];
  ...
  return (
    <ScrollView style={[containerStyle, { backgroundColor: colors.background }]} showsVerticalScrollIndicator={false}>
      <View style={[styles.header, { backgroundColor: colors.backgroundGray }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.text }]}>Etusivu</Text>
      </View>
      
      <Text style={[styles.title, { fontSize: isDesktop() ? 30 : responsiveFontSize(layout.isMobile ? 32 : 40), color: colors.text }]}>
        ...
        {sets.map((set) => (
          ...
          >
            <View style={[styles.setNumberContainer, { backgroundColor: isDarkMode ? '#2c2c2c' : '#ffffff', borderColor: colors.border }]}>
              <Text style={[
                styles.setNumber,
                { fontSize: isDesktop() ? 26 : responsiveFontSize(layout.isMobile ? 36 : 52), color: colors.primaryDark },
