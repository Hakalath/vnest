...
export const BrandColors = {
  primary: '#6f8eb1',      // Blue - Primary actions, selected states
  primaryLight: '#bbe3ff', // Light blue - Backgrounds, highlights
...
export const NeutralColors = {
  ...
  white: '#ffffff',
  background: '#ffffff',
  backgroundGray: '#dddbdb',
  backgroundLightGray: '#e7e7e7',
